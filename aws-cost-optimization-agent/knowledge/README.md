...
This directory contains the knowledge base and configuration files that provide the AWS Cost Optimization Agent with essential context about your Amazon Web Services environment and operational requirements.

## Purpose

The knowledge directory serves as the agent's reference library containing:
- **Infrastructure Configuration**: Information about your AWS setup, regions, and environment structure
- **Operational Context**: Business rules, thresholds, and organizational policies
- **Domain Knowledge**: AWS service-specific information and best practices
...
- **Account Structure**: Understanding of your AWS account organization and relationships
...
The AWS Cost Optimization Agent leverages this knowledge base to:
...
4. **Scope Analysis**: Focus on relevant regions, accounts, and services based on your configuration
...
This knowledge foundation ensures that the agent's insights and recommendations are relevant, accurate, and aligned with your specific AWS environment and business requirements.